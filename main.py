...
def run(args):
    ...
    writer = SummaryWriter(log_dir='{}/EXP{}-{}-{}-{}-{}-{}-{}-{}-{}'
                           .format(args.log_dir, args.exp_id, args.model, args.loss, args.train_proportion, args.datasets['train'],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--seed", type=int, default=29920517)
    ...
    parser.add_argument('--tested_datasets', nargs='+', type=str, default=['K'],
    ...
    for i in range(args.start_exp_id, args.num_iters):
        ...
        args.trained_model_file = 'checkpoints/{}-{}-{}-{}-{}-{}-{}-{}-{}-EXP{}-{}'.format('HVS-5M',args.model, args.loss, args.train_proportion, args.datasets['train'], args.datasets['test'], args.lr, args.batch_size, args.epochs, args.exp_id,args.seed)
        if not os.path.exists('results'):
            os.makedirs('results')
        args.save_result_file = 'results/{}-{}-{}-{}-{}-{}-{}-{}-{}-EXP{}-{}'.format('HVS-5M',args.model, args.loss, args.train_proportion, args.datasets['train'], args.datasets['test'], args.lr, args.batch_size, args.epochs, args.exp_id,args.seed)
        run(args)
